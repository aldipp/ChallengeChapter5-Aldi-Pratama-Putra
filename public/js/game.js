class Game {
    ...
    startGame(e) {
        const playerDecision = e.target.dataset.option                                      //save the player action/choice value in variable
        this.playerActionButton.forEach(choice => choice.style.pointerEvents = 'none')      //disable any action until the game refreshed
        this.status.classList.remove("status")                                              //change the status style by removing its class
